 ...
 *
 * 剩下的兩項是同一種東西：**改的是空間裡面那份名單**——編輯它、把它存成常用。
 * 這也是這一顆與首頁那一顆的分工：**進來以後做名單的事，退出去做空間的事。**
 *
  ...
  */
  ...
  return (
    ...
    >
      ...
      {/*
        兩列，都是「這份名單」的事：先把它弄對（編輯），再把它留下來（存成常用）。
        空間本身的事（建立副本、刪除空間）在首頁那顆「更多」裡，車開了那一刻的事
        在「結束點名」的確認鍵前面——這裡不重複開第二個入口。
      */}
      <div class="menu">
        {/*

...
團體現場多人同步點名。開啟房間，把 QR 給協助的人掃，大家一起點同一份名單，隨時知道誰還沒到。
...
- **「複製這間房」刻意不需要擁有權**——只要拿得到房號就能複製，而新房的擁有者是複製的那個人（對原房仍然沒有任何管理權）。理由：複製對來源房完全無害（一個字都不改），而名單本來就對所有拿得到房號的人可見，把它鎖起來沒有保護到任何東西；代價卻是主揪臨時不能來、手機沒電或在山區沒訊號時，現場沒有任何人開得出回程房。
